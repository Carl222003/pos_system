...
function createOrder() {
    ...
    const orderTotal = parseFloat(document.getElementById('order_net_total').innerText.replace(/[^\d.]/g, ''));
    ...
    .catch(error => {
        console.error('Error:', error);
        const alertModal = new bootstrap.Modal(document.getElementById('alertModal'));
        document.querySelector('#alertModal .modal-body p').textContent = 'Error creating order: ' + error.message;
        alertModal.show();
    })
    .finally(() => {
        orderBtn.disabled = false;
...
function generateReceiptHTML() {
    ...
    const discountHtml = discountType !== 'none' ? `
        <tr>
            <td>Discount (20% - ${discountType.toUpperCase()}):</td>
    ...
    return `
        <div class="receipt-container">
            <div class="receipt-header">
                ...
                <h1>MORE BITES</h1>
                <p class="tagline">Pizza & Halo-Halo</p>
                <p class="address">Corner Tiano Del Pilar Street<br>
                Cagayan de Oro, Philippines</p>
                <p class="contact">
                    Email: vegaforcecdo@yahoo.com<br>
                    Phone: 0906 933 3624
                </p>
            </div>
            ...
            <div class="receipt-section">
                ...
                <table class="order-info">
                    ...
                    <tr>
                        <td>Service:</td>
                        <td>${serviceType.replace('-', ' ').toUpperCase()}</td>
                    </tr>
                    <tr>
                        <td>Payment:</td>
                    ...
                    <tr>
                        <td>Discount Type:</td>
                        <td>${discountType.toUpperCase()}</td>
                    </tr>
                    ` : ''}
                </table>
            </div>
            ...
            <div class="receipt-footer">
                ...
                <p class="come-again">Please come again!</p>
                <p class="social-media">
                    Follow us on social media<br>
                    Facebook: @morebites<br>
                    Instagram: @morebitescdo
                </p>
                <p class="proof-text">
                    This receipt is your proof of purchase.<br>
